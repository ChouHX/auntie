...
const dictionaries = {
  zh: {
    ...
    mobileApp: {
      ...
      closePending: "关闭待付款提醒",
      localOnly: "本机订单",
      orderHistory: "订单记录",
      orderUnavailable: "订单暂未找到",
      payNow: "去付款",
      pendingDescription: "客服已为你创建订单",
      pendingTitle: "待付款订单",
    },
    ordersPage: {
      title: "本机订单",
      description: "当前浏览器保存过的付款订单。",
      emptyTitle: "暂无本机订单",
      emptyText: "客服发送的订单链接打开后，会自动出现在这里。",
      payNow: "继续付款",
      reviewOrder: "评价订单",
      reviewPending: "凭证审核中",
      viewReviewProgress: "查看审核进度",
      viewOrder: "查看订单",
      localOnly: "仅保存在当前设备",
      serviceDate: "服务日期",
      serviceArea: "服务区域",
  ...
  en: {
    common: {
      ...
      siteTitle:
        "Auntie Chen Home | Cleaning Services for Overseas Chinese Families",
      siteDescription:
        "Auntie Chen Home provides regular, deep, move-out, post-renovation, commercial, and recurring cleaning for overseas Chinese families with scope and quote confirmed first.",
      bookNow: "Book now",
      languageLabel: "中文",
    ...
    mobileApp: {
      ...
      closePending: "Dismiss pending payment",
      localOnly: "Local orders",
      orderHistory: "Order history",
      orderUnavailable: "Order was not found",
      payNow: "Pay now",
      pendingDescription: "Support has created this order for you",
      pendingTitle: "Pending payment",
    },
    ordersPage: {
      title: "Local orders",
      description: "Payment orders saved in this browser.",
      emptyTitle: "No local orders yet",
      emptyText:
        "Orders opened from support links will be saved here automatically.",
      payNow: "Continue payment",
      reviewOrder: "Review order",
      reviewPending: "Proof under review",
      viewReviewProgress: "View review status",
