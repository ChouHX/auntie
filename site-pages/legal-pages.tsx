...
const legalContent: Record<Language, Record<LegalPageType, LegalCopy>> = {
  zh: {
    privacy: {
      ...
      updatedNote:
        "本政策由杭州陈阿姨到家品牌管理有限公司（品牌名称：陈阿姨到家）发布，适用于官方网站及上门清洁服务。",
      sections: [
        {
          title: "1. 我们收集的信息",
          paragraphs: [
      ...
      contactTitle: "7. 联系我们",
      contactText:
        "运营主体：{{legalName}}（注册地：{{registrationPlace}}；注册地址：{{registeredOffice}}）。如对本隐私政策或数据处理方式有任何问题，请发送邮件至 {{contactEmail}}，也可通过联系我们页面提交需求。",
      contactLink: "前往联系我们",
    },
    terms: {
      ...
      effectiveDate: "生效日期：2025 年 6 月 3 日",
      updatedNote:
        "本服务条款由杭州陈阿姨到家品牌管理有限公司（品牌名称：陈阿姨到家）制定，用于说明预约、报价、服务履行和责任边界。",
      sections: [
        {
          title: "1. 服务范围",
          paragraphs: [
      ...
      contactTitle: "8. 联系我们",
      contactText:
        "运营主体：{{legalName}}（注册地：{{registrationPlace}}；注册地址：{{registeredOffice}}）。如对服务条款或预约规则有疑问，请发送邮件至 {{contactEmail}}，也可通过联系我们页面提交咨询。",
      contactLink: "前往联系我们",
    },
    refund: {
      ...
      updatedNote:
        "本政策由杭州陈阿姨到家品牌管理有限公司（品牌名称：陈阿姨到家）发布。我们提供上门清洁服务，具体金额、定金和付款安排以客服确认为准。",
      sections: [
        {
          title: "1. 定金规则",
          paragraphs: [
      ...
      contactTitle: "5. 联系我们",
      contactText:
        "运营主体：{{legalName}}（注册地：{{registrationPlace}}；注册地址：{{registeredOffice}}）。如有预约、付款、退款或售后问题，请发送邮件至 {{contactEmail}}，也可通过联系我们页面联系我们。",
      contactLink: "前往联系我们",
    },
    delivery: {
      ...
      effectiveDate: "生效日期：2026 年 6 月 27 日",
      updatedNote:
        "本说明由杭州陈阿姨到家品牌管理有限公司（品牌名称：陈阿姨到家）发布。由于本服务为上门服务，本页面替代传统 Shipping Policy，用于说明服务履约流程和边界。",
      sections: [
        {
          title: "1. 服务流程",
          bullets: [
      ...
      contactTitle: "5. 联系我们",
      contactText:
        "运营主体：{{legalName}}（注册地：{{registrationPlace}}；注册地址：{{registeredOffice}}）。如有服务履约、付款或售后相关问题，请发送邮件至 {{contactEmail}}，也可通过联系我们页面联系我们。",
      contactLink: "前往联系我们",
    },
  },
  en: {
    privacy: {
      ...
      updatedNote:
        "This policy is issued by Hangzhou Auntie Chen Home Brand Management Co., Ltd. (brand name: Auntie Chen Home) and applies to the official website and on-site cleaning services.",
      sections: [
        {
      ...
      contactText:
        "Operating entity: {{legalName}} (Place of registration: {{registrationPlace}}; Registered Office: {{registeredOffice}}). If you have questions about this Privacy Policy or our data practices, email {{contactEmail}}, or submit a request through the contact page.",
    ...
    terms: {
      ...
      effectiveDate: "Effective Date: June 3, 2025",
      updatedNote:
        "These Terms are issued by Hangzhou Auntie Chen Home Brand Management Co., Ltd. (brand name: Auntie Chen Home) and explain booking, estimates, service delivery, and responsibility boundaries.",
      sections: [
        {
      ...
      contactText:
        "Operating entity: {{legalName}} (Place of registration: {{registrationPlace}}; Registered Office: {{registeredOffice}}). If you have questions about these Terms or booking rules, email {{contactEmail}}, or submit an inquiry through the contact page.",
      contactLink: "Go to Contact",
    },
    refund: {
      kicker: "Cancellation & Refund Policy",
      ...
      updatedNote:
        "This policy is issued by Hangzhou Auntie Chen Home Brand Management Co., Ltd. (brand name: Auntie Chen Home). We provide on-site cleaning services. Final amount, deposit, and payment arrangement are based on support confirmation.",
      sections: [
        {
      ...
      contactText:
        "Operating entity: {{legalName}} (Place of registration: {{registrationPlace}}; Registered Office: {{registeredOffice}}). For booking, payment, refund, or after-service questions, email {{contactEmail}}, or contact us through the contact page.",
      contactLink: "Go to Contact",
    },
    delivery: {
      kicker: "Service Delivery Policy",
      ...
      effectiveDate: "Effective Date: June 27, 2026",
      updatedNote:
        "This policy is issued by Hangzhou Auntie Chen Home Brand Management Co., Ltd. (brand name: Auntie Chen Home). Because this is an on-site service, this page replaces a traditional Shipping Policy and explains service fulfillment.",
      sections: [
        {
      ...
      contactTitle: "5. Contact Us",
      contactText:
        "Operating entity: {{legalName}} (Place of registration: {{registrationPlace}}; Registered Office: {{registeredOffice}}). For service fulfillment, payment, or after-service questions, email {{contactEmail}}, or contact us through the contact page.",
      contactLink: "Go to Contact",
    },
  },
}
...
function LegalDocumentPage({ type }: { type: LegalPageType }) {
  ...
  const contactText = content.contactText
    .replaceAll("{{legalName}}", companyIdentity.legalName)
    .replaceAll("{{registrationPlace}}", companyIdentity.registrationPlace)
    .replaceAll("{{registeredOffice}}", companyIdentity.registeredOffice)
