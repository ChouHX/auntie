  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-border bg-white/94 text-slate-950 shadow-sm transition-colors duration-300 dark:border-white/10 dark:bg-slate-950/96 dark:text-white">
      <button
        aria-hidden="true"
        className={cn(
          "fixed inset-x-0 top-[60px] bottom-0 z-0 bg-slate-950/20 transition-opacity duration-300 md:top-[72px] lg:hidden dark:bg-slate-950/55",
        ...
        type="button"
      />
      <div className="relative z-10 mx-auto flex h-[60px] max-w-7xl items-center justify-between gap-2 px-3 sm:px-6 md:h-[72px] lg:px-8">
        <Link
          to="/"
        ...
        >
          <img
            ...
            className="size-8 shrink-0 rounded-xl border border-border object-cover min-[420px]:size-9 md:min-[420px]:size-10 dark:border-white/10"
          />
        ...
        <div className="flex shrink-0 items-center gap-1.5 min-[420px]:gap-2">
          <Button
            ...
            className="relative size-8 min-[420px]:size-9 md:min-[420px]:size-10"
          ...
          <Button
            ...
            className="size-8 min-[420px]:size-9 md:min-[420px]:size-10"
            onClick={toggleTheme}
            size="icon"
            type="button"
            variant="navIcon"
          ...
          <Button
            ...
            className="relative size-9 overflow-hidden md:size-10 lg:hidden"
