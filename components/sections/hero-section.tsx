  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute inset-0 bg-slate-950">
          <img
            ...
            alt=""
            aria-hidden="true"
            className="absolute inset-0 size-full object-cover object-center opacity-[1] saturate-[1.04] dark:opacity-90 dark:saturate-100 lg:dark:opacity-100"
          />
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100svh-72px)] max-w-7xl items-center px-4 py-10 sm:min-h-[calc(100vh-72px)] sm:px-6 sm:py-20 lg:px-8">
        <div
          className="animate-fade-up max-w-4xl py-4 text-white [text-shadow:0_2px_12px_rgba(2,6,23,0.5)] sm:py-8 lg:-translate-y-8 lg:py-16"
        >
          ...
          <p className="mt-5 max-w-3xl whitespace-pre-line text-base leading-7 text-white/88 sm:mt-7 sm:text-xl sm:leading-9">
...
function HeroStat({ stat }: HeroStatProps) {
  return (
    <div
      className="border-blue-100 p-2.5 text-center transition duration-300 [text-shadow:none] hover:bg-blue-50/72 max-sm:border-b odd:max-sm:border-r sm:border-r sm:p-5 sm:last:border-r-0 dark:border-white/10 dark:hover:bg-white/[0.1]"
    >
